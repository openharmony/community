...
1.  **Apply for Architecture SIG Review**:
    ...
    *   Apply for [Architecture SIG](https://shimo.im/sheets/XKq42Y1JMXSrJrAN/MODOC) issue review.
...
1.  **Apply for Architecture SIG Incubation Pre-review**: [Apply for an issue](https://shimo.im/sheets/XKq42Y1JMXSrJrAN/MODOC) and refer to the [template](../sig/sig_architecture/meetings/repository_review_template.pptx).
2.  **Apply for Quality SIG Incubation Graduation Review**: [Apply for an issue](https://shimo.im/sheets/gXqmd8B0Jpheb13o/MODOC) and refer to the [graduation standards](../sig/sig_qa/guidance_for_incubation_project_graduation_cn.md).
