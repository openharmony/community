...
汇报人： 柴仁超  
会议结论：1、针对10个真实app进行测试，其中8个发现并发错误，有2个app是误报导致的检出；2、处理then这个HB关系导致的误报；3、处理aboutToAppear和aboutToDisappear这个HB关系导致的误报。

**议题2、面向鸿蒙应用的跨语言程序分析技术**  
汇报人：伍家乐   
会议结论：1. 二进制分析针对真实应用分析进行性能优化 2. 为各模块添加性能统计数据
