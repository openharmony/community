...
| check dco                         | 可选     | DCO检查失败时，更新DCO信息后，人工触发检查DCO<br>检查通过条件：已签署DCO+PR所有提交均包含Signed-off-by信息。可参考[DCO FAQ](https://gitcode.com/openharmony/docs/blob/master/zh-cn/contribute/FAQ.md)处理 | PR创建人                                |
